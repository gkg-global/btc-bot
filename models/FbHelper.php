 ...
 */
class FbHelper extends Model
{

    public function messageTemplate($message, $bot) {
        ...
        switch ($command) {
            ...
            case 'generic':
                $bot->send(new StructuredMessage($message['sender']['id'],
                    ...
                    [
                        'elements' => [
                            new MessageElement("First item", "Item description", "https://bitcoin.org/img/icons/opengraph.png", [
                                new MessageButton(MessageButton::TYPE_POSTBACK, 'First button'),
                                new MessageButton(MessageButton::TYPE_WEB, 'Web link', 'http://facebook.com')
                            ]),
                            new MessageElement("Second item", "Item description", "https://steemitimages.com/DQmW4EVkx43qDM7eZ2YFiqY5SMmgejn2t9MfN8ZCPh5wDhC/bitcoin.jpg", [
                                new MessageButton(MessageButton::TYPE_POSTBACK, 'First button'),
                                new MessageButton(MessageButton::TYPE_POSTBACK, 'Second button')
                            ]),
                            new MessageElement("Third item", "Item description", "https://bitcoin.org/img/icons/opengraph.png", [
                                new MessageButton(MessageButton::TYPE_POSTBACK, 'First button'),
                                new MessageButton(MessageButton::TYPE_POSTBACK, 'Second button')
                            ])
                        ]
                    ...
                    [
                        'elements' => [
                            new MessageElement(
                                ...
                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCQZSCUjYkOEcmYyribUVuCA1S4OJ13y4Co16SeWTGDRPUYbQM', // image_url
                                [ // buttons
                            ...
                            new MessageElement(
                                ...
                                'https://static.wixstatic.com/media/1b3f18_8ae63a045263451c9395030e0527df8b~mv2.png/v1/fill/w_498,h_498,al_c,q_90/file.jpg', // image_url
                                [ // buttons
